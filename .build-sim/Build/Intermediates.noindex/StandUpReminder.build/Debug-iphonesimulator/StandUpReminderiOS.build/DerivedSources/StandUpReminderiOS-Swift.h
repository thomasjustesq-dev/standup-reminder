...
#ifndef STANDUPREMINDERIOS_SWIFT_H
#define STANDUPREMINDERIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StandUpReminderiOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>WeatherService.approxCoordinates(for:)</code>.
SWIFT_CLASS("_TtC18StandUpReminderiOS16LocationProvider")
...
SWIFT_CLASS("_TtC18StandUpReminderiOS20NotificationDelegate")
...
SWIFT_CLASS("_TtC18StandUpReminderiOS16PhoneWatchBridge")
@interface PhoneWatchBridge : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface PhoneWatchBridge (SWIFT_EXTENSION(StandUpReminderiOS)) <WCSessionDelegate>
