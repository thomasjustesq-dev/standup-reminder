...
#ifndef STANDUPREMINDERWATCH_SWIFT_H
#define STANDUPREMINDERWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StandUpReminderWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC20StandUpReminderWatch10WatchModel")
@interface WatchModel : NSObject <WCSessionDelegate>
